...
import androidx.compose.ui.text.withStyle // Make sure this is included
                        ...
                        if (isSettingsVisible) {
                            tts?.speak(
                                "To master the navigation through this App, follow these instructions below. " +
                                        ...
                                        "Speak any query about anything or the environment around you. " +
                                        "You can also use your earbuds or AirPods by double tapping to stop or resume the navigation. " +
            ...
            AnimatedVisibility(
                ...
                Box(
                    ...
                    val annotatedText = buildAnnotatedString {
                        ...
                        append(" the Assistant Mode ⚡ and again double tap to exit the Navigation mode. \n\n")

                        append("2️⃣ While in Navigation Mode, long press the screen to enter reading mode ☝.\n\n")

                        append("By following these steps, you can ")
                        withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
